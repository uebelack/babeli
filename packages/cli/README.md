...
AI-powered translation management CLI. Validate, sort, and automatically generate missing translations using LLMs.
...
You need at least one model provider for auto-translation:

- [`@babeli/anthropic`](../anthropic) - Anthropic Claude
- [`@babeli/ollama`](../ollama) - Ollama (local LLMs)
